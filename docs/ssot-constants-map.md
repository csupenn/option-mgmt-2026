...
| Python (`3.13`) | `apps/api/.python-version` + `pyproject.toml` `requires-python` + `Dockerfile` | manual review (M0.7+ stretch: `scripts/check_python_version.sh`) — see [ADR-0007](./decisions/0007-python-version-pin.md) |
